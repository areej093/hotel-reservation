...
public class Final extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(0, 0, 121));

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("thank you for your confidence");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hotel/sammy-line-hotel-brochure (1).png"))); // NOI18N
